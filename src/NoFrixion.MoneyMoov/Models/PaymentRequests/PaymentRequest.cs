...
public class PaymentRequest : IPaymentRequest, IWebhookPayload
{
    ...
    /// </summary>
    public List<PaymentRequestPaymentAttempt> PaymentAttempts => GetPaymentAttempts();
    ...
    public List<PaymentRequestPaymentAttempt> GetPaymentAttempts()
    {
        ...
        else
        {
            ...
            paymentAttempts.AddRange(GetCardPaymentAttempts());
            paymentAttempts.AddRange(GetPispPaymentAttempts());
    ...
    /// </summary>
    /// <returns></returns>
    public List<PaymentRequestPaymentAttempt> GetCardPaymentAttempts()
    {
    ...
    /// </summary>
    /// <returns></returns>
    public List<PaymentRequestPaymentAttempt> GetPispPaymentAttempts()
    {
